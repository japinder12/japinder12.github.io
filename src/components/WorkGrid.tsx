    ...
    <section id="work" className="work section">
      <div className="container">
        <div className="reveal" style={{ transitionDelay: '60ms' }}>
          <h2 style={{ margin: 0, fontSize: '28px', letterSpacing: '-0.01em' }}>Selected Work</h2>
          <p style={{ color: 'var(--muted)', marginTop: 8 }}>A few projects that capture my approach to motion and UX polish.</p>
        </div>
